		...
		val interruptedStateTransitions = mutableListOf<Transition>()
				...
				state("movetoport") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t013",targetState="handledeposit",cond=whenReply("moverobotdone"))
					transition(edgeName="t014",targetState="errordeposit",cond=whenReply("moverobotfailed"))
				}	 
