...
package it.unibo.test_ticketmanager
...
class Test_ticketmanager ( name: String, scope: CoroutineScope, isconfined: Boolean=false  ) : ActorBasicFsm( name, scope, confined=isconfined ){
		...
		val interruptedStateTransitions = mutableListOf<Transition>()
				...
				state("waiting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t02",targetState="handlegeneration",cond=whenRequest("generateticket"))
					transition(edgeName="t03",targetState="handleverify",cond=whenRequest("verifyticket"))
				}	 
