...
with Diagram('alarm_systemArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     alarmdevice >> Edge(color='blue', style='solid',  label='<stop &nbsp; resume &nbsp; >',  fontcolor='blue') >> coldstorageservice
diag
