		...
		val interruptedStateTransitions = mutableListOf<Transition>()
				...
				state("waiting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t06",targetState="handlegeneration",cond=whenRequest("generateticket"))
					transition(edgeName="t07",targetState="handleverify",cond=whenRequest("verifyticket"))
				}	 
